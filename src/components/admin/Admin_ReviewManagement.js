...
function ReviewManagement() {
    const [reviews, setReviews] = useState([
        { id: 1, title: '스마트인재개발원 핵심프로젝트 역량리뷰', date: '2024-05-28 ~ 06~05', status: '진행중', templateType : '역량리뷰' },
        { id: 2, title: '스마트인재개발원 핵심프로젝트 성과리뷰', date: '2024-05-28 ~ 06~05', status: '진행중',templateType : '성과리뷰' },
    ]);
