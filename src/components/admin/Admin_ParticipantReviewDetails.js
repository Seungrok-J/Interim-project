    ...
    const [reviews, setReviews] = useState([
        ...
        },
        {
            ...
            reviewData: {
                ...
                전문성: { score: '4', comment: '팀원3님은 해당 분야에 대한 깊은 지식과 전문성을 바탕으로 팀의 기술적 문제 해결에 크게 기여하셨습니다. 다만, 최신 기술 트렌드에 대한 지속적인 학습과 이를 실무에 적용하는 노력도 필요합니다. 특히, 새로운 기술을 도입할 때 이론뿐만 아니라 실제 적용 사례를 분석하여 팀원들과 공유한다면 더욱 효과적일 것입니다' },
        ...
        <Container className="mt-4" style={{ paddingLeft: '300px', paddingRight: '300px' }}>
            <Card className="shadow-sm mb-5">
                <Card.Header as="h5" className="bg-light d-flex justify-content-between align-items-center p-3">
                    ...
                    <strong>{`홍길동님에 대한 리뷰 상세보기 (${currentReview.reviewer})`}</strong>
                    <div></div>
                </Card.Header>
