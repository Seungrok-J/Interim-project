...
function MemberManagement() {
    ...
    // 가상의 구성원 데이터
    const mockMembers = [
        { id: 1, name: '홍길동', isLeader: true, organization: 'Project Management', email: 'catmin@company.com' },
        { id: 2, name: '팀원1', isLeader: false, organization: 'Development', email: 'lyh@company.com' },
        { id: 3, name: '팀원2', isLeader: false, organization: 'Design Team', email: 'jsr@company.com' },
        { id: 4, name: '팀원3', isLeader: false, organization: 'Data Team', email: 'yyj@company.com' },
    ];
