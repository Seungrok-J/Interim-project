...
function ComprehensiveSearch() {
    ...
    const [users, setUsers] = useState([
        { id: 1, name: '홍길동', position: 'Project Manager', department: '기획팀', point: 88, organization: 'MuddyBuddy',reviewData: { scores: [4, 4, 5, 3, 2], words: [{ text: 'leadership', value: 10 }, { text: 'communication', value: 5 }] } },
        { id: 2, name: '팀원1', position: 'Senior Developer', department: '개발팀', point: 92, organization: 'MuddyBuddy',reviewData:{ scores: [5, 2, 3, 5, 4], words: [{ text: 'innovation', value: 8 }, { text: 'responsibility', value: 7 }] } },
        { id: 3, name: '팀원2', position: 'UI/UX Designer', department: '개발팀', point: 85, organization: 'MuddyBuddy',reviewData: { scores: [3, 5, 4, 4, 5], words: [{ text: 'teamwork', value: 9 }, { text: 'ethics', value: 4 }] } },
        { id: 4, name: '팀원3', position: 'Product Manager', department: '기획팀', point: 90, organization: 'MuddyBuddy',reviewData: { scores: [5, 5, 5, 5, 5], words: [{ text: 'efficiency', value: 8 }, { text: 'trust', value: 6 }] } }
    ]);
