...
function My_Review() {
    const [reviews, setReviews] = useState([
        { id: 1, name: '스마트인재개발원 핵심프로젝트 역량리뷰', target: '팀원1', type: '성과', status: '대기중', deadline: '2024-06-05' },
        { id: 1, name: '스마트인재개발원 핵심프로젝트 역량리뷰', target: '팀원2', type: '성과', status: '대기중', deadline: '2024-06-05' },
        { id: 1, name: '스마트인재개발원 핵심프로젝트 성과리뷰', target: '팀원1', type: '역량', status: '대기중', deadline: '2024-06-05' },
        { id: 1, name: '스마트인재개발원 핵심프로젝트 성과리뷰', target: '팀원3', type: '역량', status: '대기중', deadline: '2024-06-05' },
    ]);
